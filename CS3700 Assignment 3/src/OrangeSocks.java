...
public class OrangeSocks implements Callable<Integer>{
	...
	public OrangeSocks(int numSocks, int numOfNumSocks) {
		this.numSocks = numSocks;
		this.numOfNumSocks = numOfNumSocks;
	}
	
	public Integer call() throws Exception{
		System.out.println("Orange Sock: Produced " + numOfNumSocks + " out of " + numSocks + " socks");
		int pairs = 0;
