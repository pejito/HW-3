...
public class RedSocks implements Callable<Integer>{
	...
	public RedSocks(int numSocks, int numOfNumSocks) {
		this.numSocks = numSocks;
		this.numOfNumSocks = numOfNumSocks;
	}
	
	public Integer call() throws Exception{
		System.out.println("Red Sock: Produced " + numOfNumSocks + " out of " + numSocks + " socks");
		int pairs = 0;
